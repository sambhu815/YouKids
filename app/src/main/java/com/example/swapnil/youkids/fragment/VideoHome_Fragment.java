...
public class VideoHome_Fragment extends Fragment {
    public static final String TAG = VideoHome_Fragment.class.getSimpleName();
    public static int i;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //for getting position from home screen
        for (int v = 0; v < videolist.size(); v++) {
            String exten = videolist.get(v).substring(0, videolist.get(v).lastIndexOf("."));

            if (exten.equals(str_name)) {
                i = v;
                break;
            }
        }
    ...
    public void showFragment(final FragmentManager fragmentManager) {
        ...
        transaction.add(Window.ID_ANDROID_CONTENT, VideoHome_Fragment.this, "VideoHome");
